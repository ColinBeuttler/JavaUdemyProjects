...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ArrayList<Transaction> transations = new ArrayList<Transaction>();
            runTransactions(transations);
            bank.deductTaxes();
    ...
    public static Account createObject(String[] string) {
        try {
            return (Account) Class.forName("src.main.model.account." + string[0])
                    .getConstructor(String.class, String.class, double.class)
                    .newInstance(string[1], string[2], Double.parseDouble(string[3]));
        } catch (Exception e) {
            System.out.println(e.getMessage());
            return null;
        }
